    ...
    <>
      ...
      <div className='visualizer' >
        ...
        <div className='projimg'>
          ...
          <img  style={{ display: 'grid', margin: 'auto', flexDirection: 'row', justifyContent: 'center', transform:'rotate(270deg)',alignItems: 'center', maxHeight:'30vh', maxWidth: '30vw', textAlign: 'center' }}src={images.volts} />
